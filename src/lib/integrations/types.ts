...
export interface RatingHistoryPoint { date: string; value: number; label?: string; description?: string; }
...
export interface ProfileActivity { date: string; count: number; label?: string; type?: string; }
export interface ProfileData { bio?: string; location?: string; joinedAt?: string; displayName?: string; avatarUrl?: string | null; profileUrl?: string; metrics?: Metric[]; activity?: ProfileActivity[]; ratingHistory?: RatingHistoryPoint[]; highlights?: ProfileHighlight[]; breakdowns?: ProfileBreakdown[]; githubContributions?: GitHubContributionAnalytics; privateAccess?: boolean; accessibleRepoCount?: number; privateRepoCount?: number; repositories?: GitHubRepository[]; publicRepositories?: GitHubRepository[]; privateRepositories?: GitHubRepository[]; ownershipVerified?: boolean; verificationMethod?: string; verificationVerifiedAt?: string; dataSource?: 'public-api' | 'public-profile' | 'oauth' | 'platform-verified'; dataNotice?: string; }
